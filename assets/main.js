...
(function() {
	...
	// Icons: icons05.
		$('#icons05 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons06.
		$('#icons06 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons07.
		$('#icons07 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons08.
		$('#icons08 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons09.
		$('#icons09 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons10.
		$('#icons10 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons11.
		$('#icons11 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons12.
		$('#icons12 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons13.
		$('#icons13 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons14.
		$('#icons14 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons15.
		$('#icons15 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Icons: icons16.
		$('#icons16 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
	...
	// Buttons: navbarlinks.
		...
		$('#navbarlinks > li:nth-child(7) > a').addEventListener(
			'click',
			function(event) { 
				displaynavbarlinks(xnav)
			}
		...
		$('#navbarlinks > li:nth-child(8) > a').addEventListener(
			'click',
			function(event) { 
				displaynavbarlinks(xnav)
			}
	...
	// Links: links02.
		$('#links02 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				event.preventDefault();
				event.stopPropagation();
