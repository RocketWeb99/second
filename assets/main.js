				...
				sections = {
					'portfolio': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/#portfolio' });
								},
							],
						},
					},
					'portfolio1': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/#portfolio1' });
								},
							],
						},
					},
					'portfolio2': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/#portfolio2' });
								},
							],
						},
					},
					'contact': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/#contact' });
								},
							],
						},
					},
					'ujhygf': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/#ujhygf' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'GTM-PVRXZXX', { 'page_path': '/' });
								},
							],
						},
					},
